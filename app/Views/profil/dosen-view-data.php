<form action="<?= base_url('profil/prosesEditDosen'); ?>" method="post" class="j-pro formEdit">
    <!-- end /.header-->
    <div class="j-content">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-block user-radial-card">
                        <div data-label="50%" class="radial-bar radial-bar-90 radial-bar-lg radial-bar-danger">
                            <img src="<?= $dosen['foto'] == null ? base_url('assets/images/auth/no-image.png') : base_url('assets/images/user-profile/' . $dosen['foto'] . '') ?>" alt="User-Image" style="width:285px; height:285px">
                        </div>
            ...
            <div class="col-lg-6">
                <!-- start name -->
                <input type="text" class="" placeholder="" value="<?= $dosen['nip'] ?>" id="nip" name="nip" hidden>
                <input type="text" class="" placeholder="" value="<?= $dosen['foto'] ?>" id="nama_file_lama" name="nama_file_lama" hidden>
                <div class="j-unit">
                    ...
                    <div class="j-input">
                        ...
                        <input type="text" class="" placeholder="" value="<?= $dosen['nama_dosen'] ?>" id="nama" name="nama">
                ...
                <div class="j-unit">
                    ...
                    <div class="j-input">
                        ...
                        <input type="email" placeholder="" value="<?= $dosen['email'] ?>" id="email" name="email">
                    </div>
                ...
                <div class="j-unit">
                    ...
                    <div class="j-input">
                        ...
                        <input type="text" placeholder="" value="<?= $dosen['telepon'] ?>" id="telepon" name="telepon">
                    </div>
                ...
                <div class="j-unit">
                    ...
                    <div class="j-input">
                        <textarea placeholder="" spellcheck="false" id="alamat" name="alamat"><?= $dosen['alamat'] ?></textarea>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    <img src="<?= $dosen['foto'] == null ? base_url('assets/images/auth/no-image.png') : base_url('assets/images/user-profile/' . $dosen['foto'] . '') ?>" class="img-preview-foto" style="border-radius: 20px; width:250px; height:250px; display:block; margin:auto">
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".formEditFoto").click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url('profil/prosesEditFotoDosen') ?>',
                data: fd,
                dataType: "json",
                contentType: false,
                processData: false,
