                                         ...
                                         <div class="row">
                                             <div class="col-md-12">
                                                 ...
                                                 <div class="social-wallpaper">
                                                     <img src="<?= $user['foto_cover'] == null ? base_url('assets/images/auth/cover-profil.jpeg') : base_url('assets/images/user-profile/' . $user['foto_cover'] . '') ?>" width="300px" height="300px" class="width-100" alt="">
                                                 ...
                                                 <div class="social-timeline-left">
                                                     ...
                                                     <div class="card">
                                                         <div class="social-profile">
                                                             <img class="width-100" src="<?= $user['foto'] == null ? base_url('assets/images/auth/no-image.png') : base_url('assets/images/user-profile/' . $user['foto'] . '') ?>" alt="" width="250px">
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <div class="container">
                     <img src="<?= $user['foto_cover'] == null ? base_url('assets/images/auth/no-image.png') : base_url('assets/images/user-profile/' . $user['foto_cover'] . '') ?>" class="img-preview" style="border-radius: 20px; width:250px; height:250px">
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <div style="font-size: 12px;margin-top:7px" class="text-danger errorfile"></div>
                 <div class="container">
                     <img src="<?= $user['foto'] == null ? base_url('assets/images/auth/no-image.png') : base_url('assets/images/user-profile/' . $user['foto'] . '') ?>" class="img-preview-foto" style="border-radius: 20px; width:250px; height:250px">
                     <input type="text" class="id_user_cover" value="<?= $user['id'] ?>" hidden>
                 </div>
             </div>
             <div class="modal-footer">
 ...
 <script>
     ...
     $(".formEditFoto").click(function(e) {
         ...
         $.ajax({
             type: "post",
             url: '<?= base_url('profil/prosesEditFotoOperatorBeranda') ?>',
             data: fd,
             dataType: "json",
             contentType: false,
             processData: false,
     ...
     $(".formEditFotoCover").click(function(e) {
         ...
         $.ajax({
             type: "post",
             url: '<?= base_url('profil/prosesEditFotoCoverOperator') ?>',
             data: fd,
             dataType: "json",
             contentType: false,
             processData: false,
